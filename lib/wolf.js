...
Wolf.prototype.getDrafts = function(id, callback) {
  this._get('api/public/v1/customer/'+id+'/draft/streetlib/', function(error, body) {
    callback(error, body.response);
  });
};

Wolf.prototype.getDraft = function(id, guid, callback) {
  this._get('api/public/v1/customer/'+id+'/draft/'+guid+'/', function(error, body) {
    callback(error, body.response);
  });
};
...
Wolf.prototype.getInvoices = function(id, callback) {
  this._get('api/public/v1/customer/'+id+'/invoice/streetlib/', function(error, body) {
    callback(error, body.response);
  });
};